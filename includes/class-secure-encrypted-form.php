...
class Secure_Encrypted_Form {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Secure_Encrypted_Form_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'SECURE_ENCRYPTED_FORM_VERSION' ) ) {
			$this->version = SECURE_ENCRYPTED_FORM_VERSION;
		} else {
			$this->version = '1.0.0';
		}
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'admin_notices', $plugin_admin, 'check_php_mail_func' );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Secure_Encrypted_Form_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Secure_Encrypted_Form_Loader    Orchestrates the hooks of the plugin.
	 */
